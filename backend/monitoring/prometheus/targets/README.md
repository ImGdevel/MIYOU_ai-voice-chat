...
- For remote deployment, `deploy/aws/deploy_remote_prometheus.sh` generates and uploads `app-targets.json`.
...
bash ./deploy/aws/deploy_remote_prometheus.sh ubuntu@<MONITORING_SERVER_IP>
```
