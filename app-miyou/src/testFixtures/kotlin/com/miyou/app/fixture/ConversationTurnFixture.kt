...
object ConversationTurnFixture {
    ...
    @JvmStatic
    fun create(sessionId: ConversationSessionId): ConversationTurn = ConversationTurn.create(sessionId, DEFAULT_QUERY)

    @JvmStatic
    fun create(query: String): ConversationTurn = ConversationTurn.create(ConversationSessionFixture.createId(), query)

    @JvmStatic
    fun createWithResponse(): ConversationTurn =
        ConversationTurn
            .create(ConversationSessionFixture.createId(), DEFAULT_QUERY)
