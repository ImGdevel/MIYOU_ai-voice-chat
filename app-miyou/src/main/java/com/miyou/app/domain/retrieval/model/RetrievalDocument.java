...
public record RetrievalDocument(
	String content,
	com.miyou.app.domain.retrieval.model.SimilarityScore score,
	...
	public static RetrievalDocument of(String content, int score) {
		return new RetrievalDocument(content,
			com.miyou.app.domain.retrieval.model.SimilarityScore.of(score), Map.of());
	}
	...
	public static RetrievalDocument withMetadata(String content,
		...
		Map<String, Object> metadata) {
		return new RetrievalDocument(content,
			com.miyou.app.domain.retrieval.model.SimilarityScore.of(score), metadata);
	}
}
