...
class MissionApplicationServiceTest {
	...
	inner class GetAllMissions {
		...
		fun getAllMissions_returnsAll() {
			...
			val mission2 = MissionFixture.create("referral-1", com.miyou.app.domain.mission.model.MissionType.REFERRAL, 300L, false)
	...
	inner class CompleteMission {
		...
		fun completeMission_notFound_throws404() {
			val userId = UserIdFixture.create()
			val unknownId = com.miyou.app.domain.mission.model.MissionId.of("unknown-mission")
		...
		fun completeMission_alreadyRewarded_nonRepeatable_throws409() {
			val userId = UserIdFixture.create()
			val mission = MissionFixture.create("one-time-mission", com.miyou.app.domain.mission.model.MissionType.SHARE_SERVICE, 500L, false)
			val missionId = mission.missionId()
			val completedWithSameId = com.miyou.app.domain.mission.model.UserMission(
				userId,
				missionId,
		...
		fun completeMission_repeatable_alreadyRewarded_succeeds() {
			val userId = UserIdFixture.create()
			val repeatableMission = MissionFixture.create(
				"daily-mission",
			...
			val previouslyRewarded = com.miyou.app.domain.mission.model.UserMission(
				userId,
				missionId,
				com.miyou.app.domain.mission.model.MissionStatus.REWARDED,
