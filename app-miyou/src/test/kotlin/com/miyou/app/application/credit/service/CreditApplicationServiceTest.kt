...
class CreditApplicationServiceTest {
    ...
    inner class GetTransactions {
        ...
        fun getTransactions_returnsSortedList() {
            ...
            StepVerifier
                .create(service.getTransactions(userId, PageRequest.of(0, 20)))
                .expectNextCount(2)
                .verifyComplete()
        }
    }
    ...
    inner class GrantSignupBonus {
        ...
        fun grantSignupBonus_createsChargeTransaction() {
            ...
            StepVerifier
                .create(service.grantSignupBonus(userId))
                .assertNext { tx ->
    ...
    inner class ChargeByPayment {
        ...
        fun chargeByPayment_newUser_startsFromZero() {
            ...
            StepVerifier
                .create(service.chargeByPayment(userId, 10000L, source))
                .assertNext { tx ->
                    assertThat(tx.balanceBefore()).isEqualTo(0L)
        ...
        fun grantMissionReward_addsRewardToBalance() {
            ...
            val missionId =
                com.miyou.app.domain.mission.model.MissionId
                    .of(MissionFixture.DEFAULT_MISSION_ID)
    ...
    inner class InitializeIfAbsent {
        ...
        fun initializeIfAbsent_noRecord_grantsBonus() {
            ...
            StepVerifier
                .create(service.initializeIfAbsent(userId))
                .verifyComplete()
