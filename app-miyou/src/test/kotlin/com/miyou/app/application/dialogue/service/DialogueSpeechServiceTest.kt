...
class DialogueSpeechServiceTest {
	...
	fun transcribeAndRespond_shouldReturnTranscriptionAndResponse() {
		...
		val service = DialogueSpeechService(
			sttPort,
			dialoguePipelineUseCase,
			SttPolicy(25L * 1024L * 1024L, "ko"),
		)
		val audioFile = createFilePart(
			"voice.mp3",
	...
	private fun createFilePart(filename: String, contentType: MediaType, bytes: ByteArray): FilePart {
