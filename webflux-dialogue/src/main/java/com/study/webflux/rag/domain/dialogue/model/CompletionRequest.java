...
public record CompletionRequest(
	...
	public static CompletionRequest fromPrompt(String prompt, String model) {
		return new CompletionRequest(
			List.of(com.study.webflux.rag.domain.dialogue.model.Message.user(prompt)), model, false,
			Map.of());
	}

	public static CompletionRequest streaming(String prompt, String model) {
		return new CompletionRequest(
			List.of(com.study.webflux.rag.domain.dialogue.model.Message.user(prompt)), model, true,
			Map.of());
	}
