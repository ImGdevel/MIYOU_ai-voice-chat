...
public interface VectorMemoryPort {
	 ...
	 * @param memory  저장하거나 업데이트할 Memory 객체
	 ...
	 * @param queryEmbedding 검색 쿼리의 벡터 임베딩
	 * @param types 검색할 메모리 타입 목록
	 * @param importanceThreshold 중요도 임계값
	 * @param topK 검색할 상위 메모리 개수
	 ...
	 * @param newImportance 새로운 중요도 값
	 * @param lastAccessedAt 마지막 접근 시간
	 * @param accessCount 접근 횟수
