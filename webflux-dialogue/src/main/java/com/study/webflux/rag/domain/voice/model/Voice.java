...
public class Voice {
	...
	public com.study.webflux.rag.domain.voice.model.VoiceStyle getStyle() {
		return style;
	}
	...
	public static class Builder {
		...
		private com.study.webflux.rag.domain.voice.model.VoiceSettings settings = com.study.webflux.rag.domain.voice.model.VoiceSettings
			.defaultSettings();
		private String language = "ko";
		private com.study.webflux.rag.domain.voice.model.VoiceStyle style = com.study.webflux.rag.domain.voice.model.VoiceStyle.NEUTRAL;
		private com.study.webflux.rag.domain.voice.model.AudioFormat outputFormat = com.study.webflux.rag.domain.voice.model.AudioFormat.WAV;
		...
		public Builder style(com.study.webflux.rag.domain.voice.model.VoiceStyle style) {
			this.style = style;
			return this;
		}
