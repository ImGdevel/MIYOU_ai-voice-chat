package com.study.webflux.rag.application.credit.service;
...
class CreditApplicationServiceTest {
	...
	class GetTransactions {
		...
		void getTransactions_returnsSortedList() {
			UserId userId = UserIdFixture.create();
			CreditTransaction tx1 = com.study.webflux.rag.fixture.CreditTransactionFixture
				.deduction(userId, 5000L);
			CreditTransaction tx2 = com.study.webflux.rag.fixture.CreditTransactionFixture
	...
	class DeductForConversation {
		...
		void deduct_sufficient_returnsTransaction() {
			...
			CreditTransaction savedTx = com.study.webflux.rag.fixture.CreditTransactionFixture
				.deduction(userId, 5000L);
	...
	class GrantMissionReward {
		...
		void grantMissionReward_addsRewardToBalance() {
			...
			var missionId = com.study.webflux.rag.domain.mission.model.MissionId.of(
			...
			StepVerifier.create(service.grantMissionReward(userId, missionId, 500L, "SHARE_SERVICE"))
				.assertNext(tx -> {
					...
					assertThat(tx.source().sourceType())
						.isEqualTo(com.study.webflux.rag.domain.credit.model.CreditSourceType.MISSION_REWARD);
				})
				.verifyComplete();
		}
	}
